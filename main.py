...
class RecordedVideosScreen(Screen):
    def __init__(self, **kwargs):
        ...
        self.video_list = [
            {"title": "Speech Exercise 1", "file": "video1.mp4"},
            {"title": "Speech Exercise 2", "file": "video2.mp4"},
            {"title": "Speech Exercise 3", "file": "video3.mp4"},
            {"title": "Speech Exercise 4", "file": "video4.mp4"},
